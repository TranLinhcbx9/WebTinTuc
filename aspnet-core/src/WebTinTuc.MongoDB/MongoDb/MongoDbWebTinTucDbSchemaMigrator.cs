...
{
    public class MongoDbWebTinTucDbSchemaMigrator : IWebTinTucDbSchemaMigrator , ITransientDependency
    {
        private readonly IServiceProvider _serviceProvider;

        public MongoDbWebTinTucDbSchemaMigrator(IServiceProvider serviceProvider)
        {
